...
func runBuildImpl(cmd *command) (*packages.Package, error) {
	...
	if !nmpkgs["github.com/neflyte/fyne/v2/internal/driver/mobile/app"] {
		return nil, fmt.Errorf(`%s does not import "github.com/neflyte/fyne/v2/internal/driver/mobile/app"`, pkg.PkgPath)
	}
...
func extractPkgs(nm string, path string) (map[string]bool, error) {
	if buildN {
		return map[string]bool{"github.com/neflyte/fyne/v2/internal/driver/mobile/app": true}, nil
	}
	r, w := io.Pipe()
